...
def main():
    print("📊 Generating 3D PCA from Gemini embeddings...")
    ...
    try:
        ...
        print("❌ Error: book_gemini_embeddings_200.json not found.")
        return
    
    print(f"📈 Loaded {len(embeddings_data)} user embeddings")
    ...
    print(f"\n🎉 Successfully generated 3D PCA projection from Gemini embeddings!")
    print(f"📁 React data saved to: {react_output}")
    print(f"📁 Embeddings saved to: {react_embeddings}")  
    print(f"📁 Visualization saved to: gemini_book_pca_3d.png")
